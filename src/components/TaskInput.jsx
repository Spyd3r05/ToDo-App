...
const addTasks = ()=>{
  ...
  return (
    <div className="w-[95%] ltr flex items-center justify-center h-10 bg-[#333] shadow-sm shadow-whitesmoke my-8 mx-auto rounded-[10px] px-8">
        <input type="text"  className="ms-2 text-left mx-2.5 flex-1 h-auto border-none outline-none bg-transparent text-white text-[16px] placeholder:text-white placeholder:text-[12px]"
